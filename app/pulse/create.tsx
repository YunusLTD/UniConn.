...
import { createPulse } from '../../src/api/pulse';
...
export default function CreatePulseScreen() {
    ...
    const currentAlias = useMemo(() => getPulseAlias('composer', aliasSeed), [aliasSeed]);
    ...
    const handlePost = async () => {
        ...
        try {
            ...
            Alert.alert(t('error'), e.message || t('pulse_failed_to_post'));
        } finally {
            setPosting(false);
        }
    };
                ...
                headerRight: () => (
                    ...
                    >
                        {posting ? (
                            ...
                            <Text style={styles.postBtnText}>{t('pulse_create_cta')}</Text>
                        )}
                    </TouchableOpacity>
                ),
            }} />
